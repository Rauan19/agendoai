...
export function setupAuth(app: Express): void {
  ...
  const sessionSettings: session.SessionOptions = {
    ...
    store: sessionStore,
    cookie: {
      secure: false, // Para desenvolvimento em Replit, deve ser false
      maxAge: 1000 * 60 * 60 * 24 * 7, // 1 week
      httpOnly: true,
      sameSite: 'lax', // Permite que o cookie seja enviado em requests de redirecionamento de outros sites
