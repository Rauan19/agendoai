...
export default function AppointmentDetailsPage() {
  ...
  const appointmentId = paramsId ? parseInt(paramsId) : 0;

  // Logging para debug
  console.log("Acessando detalhes do agendamento ID:", paramsId, "parsed:", appointmentId);

  if (!paramsId || appointmentId === 0 || isNaN(appointmentId)) {
    console.log("ID do agendamento inválido:", paramsId);
    return (
      <ClientLayout>
