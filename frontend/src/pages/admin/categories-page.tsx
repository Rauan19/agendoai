...
export default function CategoriesPage() {
  ...
  useEffect(() => {
    if (editingCategory) {
      form.reset({
        ...
        nicheId: editingCategory.nicheId || undefined,
      });
    } else {
      form.reset({
        name: "",
  ...
  const handleEditCategory = (category: Category) => {
    ...
    form.reset({
      ...
      nicheId: category.nicheId || undefined,
    });
  };
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          >
                            ...
                            <SelectContent>
                              {niches?.filter((niche: any) => niche.id && niche.id.toString()).map((niche: any) => (
                          ...
                          <FormDescription>
                            Selecione o nicho ao qual esta categoria pertence
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
